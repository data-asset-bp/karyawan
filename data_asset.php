  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      <div class="card-header">
        ...
        <<<<<<< HEAD <button type="button" class="btn btn-primary btn-sm ml-2" data-toggle="modal" data-target="#myModal">
          ADD
          </button>
          ...
          <div class="card mb-4">
            <div class="card-header">
              <form method="post">
                ...
                <br>
                <label>Select Search Type</label>
                <<<<<<< HEAD <input type="text" name="carinama" class="form-control" placeholder="Input Search Type"><br>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= sts_check($sts); ?></td>
                        <td>
                          <<<<<<< HEAD <button type="button" class="btn btn-danger btn-sm ml-2" data-toggle="modal" data-target="#checkout<?= $id; ?>">
                            =======
                        ...
                        <td>
                          <<<<<<< HEAD <button type="button" class="btn btn-warning btn-sm ml-2" data-toggle="modal" data-target="#edit<?= $id; ?>">
                            Edit
                            </button>
