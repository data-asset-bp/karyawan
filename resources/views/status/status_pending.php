                        ...
                        <div class="table table-responsive">
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = mysqli_query($con, "SELECT * FROM data_asset where no_asset and EXISTS (SELECT * FROM data_chek_asset where sts_chek=1 and data_chek_asset.no_asset=data_asset.no_asset)ORDER BY cap_date DESC");
