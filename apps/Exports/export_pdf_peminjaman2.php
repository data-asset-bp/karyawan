        ...
        <div class="col-sm-4 invoice-col">
            <table style="width:100%;text-align:center;">
                <tr>
                    ...
                    <td style="width:12%;line-height:1;border:1px solid;padding:5px;" class="table table-bordered"><h4> NON <br> NB / PC </h4></td>
                </tr>
            </table>
        </div>
        <br>
...
$mpdf->WriteHTML($html);
$mpdf->Output("Cetak Surat Peminjaman Asset NON PC or NB [$asset->no_asset].pdf", 'I');
