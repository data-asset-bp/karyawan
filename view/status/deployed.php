            ...
            <div class="table table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                  ...
                  if ($pil == 1) {
                    $sql = mysqli_query($con, "SELECT * FROM data_asset where no_asset like '%$namacari%' and NOT EXISTS (SELECT * FROM data_chek_asset where sts_chek=3 and data_chek_asset.no_asset=data_asset.no_asset)");
                  } elseif ($pil == 2) {
                    $sql = mysqli_query($con, "SELECT * FROM data_asset where asset_type like '%$namacari%' and NOT EXISTS (SELECT * FROM data_chek_asset where sts_chek=3 and data_chek_asset.no_asset=data_asset.no_asset)");
                  } elseif ($pil == 3) {
                    $sql = mysqli_query($con, "SELECT * FROM data_asset where no_serial like '%$namacari%' and NOT EXISTS (SELECT * FROM data_chek_asset where sts_chek=3 and data_chek_asset.no_asset=data_asset.no_asset)");
                  } elseif ($pil == 4) {
                    $sql = mysqli_query($con, "SELECT * FROM data_asset where asset_description like '%$namacari%' and NOT EXISTS (SELECT * FROM data_chek_asset where sts_chek=3 and data_chek_asset.no_asset=data_asset.no_asset)");
                  } else {
                    $sql = mysqli_query($con, "SELECT * FROM data_asset where NOT EXISTS (SELECT * FROM data_chek_asset where sts_chek=3 and data_chek_asset.no_asset = data_asset.no_asset)");
                  }
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= sts_check($sts); ?></td>
                      <td>
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#checkout<?= $id; ?>">
                          CHECKOUT
                        </button>
    ...
    <div class="modal-content">
      ...
      <form method="post">
        <div class="modal-body">
          ...
          <button type="submit" class="btn btn-primary" name="tambahasset">Simpan</button>
        </div>
      </form>
